...
<footer class="nw-footer">
  <div class="nw-footer__shell">
    <div class="nw-footer__top">
      <div class="nw-footer__brand">
        <a class="nw-footer__logo" href="index.html#inicio" aria-label="Volver al inicio">
          <span class="nw-footer__logo-mark"><img src="images/logo-wavelet-mark.png?v=1" alt="" aria-hidden="true"></span>
    ...
    <div class="nw-footer__bottom"><p>© <span data-current-year>${year}</span> Notion Wavelet. Todos los derechos reservados.</p></div>
  </div>
</footer>`;
})();
